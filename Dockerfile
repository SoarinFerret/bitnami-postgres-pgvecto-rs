...
USER root
RUN apt-get install -y /tmp/vectors.deb && rm -f /tmp/vectors.deb && mv /usr/lib/postgresql/*/lib/vectors.so /opt/bitnami/postgresql/lib/ && mv usr/share/postgresql/*/extension/vectors* opt/bitnami/postgresql/share/
USER 1001
